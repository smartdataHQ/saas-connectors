...
- **Template install of an unknown or inaccessible template.** The connector must surface Cyclr's specific error (template not visible to this Partner, incorrect template version, Account lacks required Connectors) rather than a generic failure.
